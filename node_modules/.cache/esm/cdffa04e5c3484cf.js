let Bullet;_5c3‍.x([["Player",()=>Player]]);_5c3‍.w("./bullet.js",[["Bullet",["Bullet"],function(v){Bullet=v}]]);
    ...
    shoot(bulletmanager){
        ...
        if (look.dx == 0 && look.dy == 0)
            return
        bulletmanager.add(new (_5c3‍.a("Bullet",Bullet))(this.id, this.X, this.Y, look.dx/100, look.dy/100, this.color))
        this.ammo--
    }
    updateAmmo(){
        this.ammo_ticks++
