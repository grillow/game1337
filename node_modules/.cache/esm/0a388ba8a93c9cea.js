let Player,BulletManager,AntiXSS;_a93‍.w("../game/player.js",[["Player",["Player"],function(v){Player=v}]]);_a93‍.w("../game/bulletmanager.js",[["BulletManager",["BulletManager"],function(v){BulletManager=v}]]);_a93‍.w("./antixss.js",[["AntiXSS",["AntiXSS"],function(v){AntiXSS=v}]]);
...
io.sockets.on('connection', function(socket){
    ...
    socket.on('disconnect', function(){
        if (!socket.logged)
            return
        _a93‍.g.console.log(socket.Player.nickname + ' disconnected')
