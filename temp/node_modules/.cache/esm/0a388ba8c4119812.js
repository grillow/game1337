let Player,BulletManager,AntiXSS;_c41‍.w("../game/player.js",[["Player",["Player"],function(v){Player=v}]]);_c41‍.w("../game/bulletmanager.js",[["BulletManager",["BulletManager"],function(v){BulletManager=v}]]);_c41‍.w("./antixss.js",[["AntiXSS",["AntiXSS"],function(v){AntiXSS=v}]]);
...
io.sockets.on('connection', function(socket){
    ...
    socket.on('disconnect', function(){
        if (!socket.logged)
            return
        _c41‍.g.console.log(socket.Player.nickname + ' disconnected')
