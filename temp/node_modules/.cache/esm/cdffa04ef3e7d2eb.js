let Bullet;_f3e‍.x([["Player",()=>Player]]);_f3e‍.w("./bullet.js",[["Bullet",["Bullet"],function(v){Bullet=v}]]);
    ...
    updateVelocity(aX, aY){
        ...
        this.vX = Math.min(vX + aX * Player.acceleration, Player.maxSpeed)
        this.vY = Math.min(vY + aY * Player.acceleration, Player.maxSpeed)
    }
    updatePosition(){
        this.X += this.vX
        this.Y += this.vY
    ...
    shoot(bulletmanager){
        ...
        if (look.dx == 0 && look.dy == 0)
            return
        bulletmanager.add(new (_f3e‍.a("Bullet",Bullet))(this.id, this.X, this.Y, look.dx/100, look.dy/100, this.color))
        this.ammo--
    }
    updateAmmo(){
        this.ammo_ticks++
