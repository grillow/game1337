let Player;_17a‍.x([["Bullet",()=>Bullet]]);_17a‍.w("./player.js",[["Player",["Player"],function(v){Player=v}]]);
    ...
    collide(players){
        players.forEach(player => {
            ...
            if (mag2 < (Bullet.radius + _17a‍.a("Player",Player).radius)*(Bullet.radius + _17a‍.a("Player",Player).radius) && this.owner != player.id){
